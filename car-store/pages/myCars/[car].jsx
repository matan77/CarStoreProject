...
export default function CarRegistrationPage() {
    ...
    useEffect(() => {
        ...
        api.get(`/api/cars/${router.query.car}`).then((res) => {
            let car = res.data;
            delete car.seller;  
            setFormData(car);
        }).catch((error) => {
    ...
    const handleSubmit = (e) => {
        e.preventDefault();
        setErrors({});
        api.patch(`/api/cars/${router.query.car}`, formData)
            .then((res) => {
                router.push('/myCars');
            })
            .catch((error) => {
    ...
    return (
        <div className="flex min-h-full flex-col justify-center px-6 py-12 lg:px-8">
            <div className="sm:mx-auto sm:w-full sm:max-w-sm">
                <h2 className="mt-10 text-center text-2xl font-bold leading-9 tracking-tight text-gray-900">Update your car details</h2>
                {errors.message && (
